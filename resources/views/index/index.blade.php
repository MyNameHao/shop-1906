...
<div class="section product">
    <div class="container">
        ...
        <div class="row">
            @foreach($newgoods as $key=>$val)
            <div class="col s6">
                <div class="content">
                    <a href="{{url('/goods/single'.'?goods_id='.$val['goods_id'])}}">
...
<div class="promo section">
    <div class="container">
        <div class="content">
            <h4>特价商品</h4>
            <p>特价商品最低5折出售-速来抢购</p>
            <button class="btn button-default">特卖</button>
        </div>
    </div>
</div>
<!-- end promo -->
    ...
    <div class="container">
        ...
        <div class="pagination-product">
            <ul>
                ...
                @for($i=1;$i<=$page;$i++)
                    @if($i==$pages)
                        <li class="active page" pagenum="{{$i}}">{{$i}}</li>
                    @else
                        <li class="page" pagenum="{{$i}}">{{$i}}</li>
                    @endif
                @endfor
            </ul>
        </div>
...
<script>
    $(function(){
        $(document).on('click','.page',function(){
            ...
            var _page=$(this).attr('pagenum');
            $.get(
                    'http://www.1906.com?page='+_page,
                    function(res){
                        $('#paging').html(res);
                    }
